...
```bash
bash <<'SCRIPT'
~/.codex/skills/railway/lib/railway-api.sh \
...
**Rename project:**
```bash
~/.codex/skills/railway/lib/railway-api.sh '<mutation>' '{"id": "uuid", "input": {"name": "new-name"}}'
```

**Enable PR deploys:**
```bash
~/.codex/skills/railway/lib/railway-api.sh '<mutation>' '{"id": "uuid", "input": {"prDeploys": true}}'
```

**Make project public:**
```bash
~/.codex/skills/railway/lib/railway-api.sh '<mutation>' '{"id": "uuid", "input": {"isPublic": true}}'
```

**Multiple fields:**
```bash
~/.codex/skills/railway/lib/railway-api.sh '<mutation>' '{"id": "uuid", "input": {"name": "new-name", "prDeploys": true}}'
```
